...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]', full_name='$_POST[fname]', email='$_POST[email]',PhoneNumber='$_POST[phone]',password='".$_POST["password"]."', date='$_POST[date]', address='$_POST[address]' where user_id='$_GET[user_upd]' ";
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger"  value="<?php  echo $newrow['full_name'];  ?>" placeholder="jon">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="date" name="date" class="form-control form-control-danger"  value="<?php  echo $newrow['date'];  ?>">
                                                    </div>
                                            </div>
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control form-control-danger"   value="<?php  echo $newrow['PhoneNumber'];  ?>" placeholder="phone">
                                                    </div>
                                                </div>
                                            </div>
