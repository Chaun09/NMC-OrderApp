...
<link href="../css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="../css/style copy.css" rel="stylesheet"> </head>
<!--[if lt IE 9]>
      ...
      <div class="grid_12">
          ...
          <nav>
            <ul class="sf-menu">
              ...
              <li class="dropmenu"><a href="php/user-profile.php"> My Account <i class="fas fa-caret-down"></i></a>
                ...
                <ul>
                    <li><a href="user-profile.php" title="Profile">Profile</a></li>
                    <li><a href="user-accsetting.php" title="Settings">Settings</a></li> 
        ...
        <section class="popular">
            <div class="container">
                ...
                <?php
  $query = 'SELECT * FROM products WHERE type = "Bun"';
  $query_res = mysqli_query($link, $query);


if (isset($_GET['submit1'])) {
  $searchTerm = $_GET['search1'];
  $sql1 = "SELECT * FROM products WHERE  product_name like '%$searchTerm%' ORDER BY RAND() LIMIT 9 ";

  $query_res = $link->query($sql1);
...
?>
						...
						<?php 			
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item" >
                                            <div class="food-item-wrap" style="border-radius:20px;">
                                                <div class="figure-wrap bg-image"><img height="220px" width="600px" src="../images/'.$r['Image'].'"></div>
                                                <div class="content">
                                                    <h5><a href="dishes.php?res_id='.$r['product_id'].'">'.$r['product_name'].'</a></h5>
                                                    <div style="color: green;" class="product-name">'.$r['description'].'</div>
                                                    <div class="price-btn-block"> <span style="color: green;" class="price">Price: '.$r['price'].'$</span> <a href="dishes.php?res_id='.$r['product_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center" style="background-color: none;">
                    <h2 style="color: green; font-size: 40px;">Easy to Order</h2>
                    <div class="row how-it-works-solution">
                        <div style="color: green" class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div style="color: green" class="how-it-works-wrap">
                                <div style="color: green" class="step step-1">
                                    ...
                                    <h3 style="color: green">Choose a restaurant</h3>
                                    <p style="color: green">We"ve got your covered with menus from a variety of delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3 style="color: green">Choose a dish</h3>
                                <p style="color: green">We"ve got your covered with a variety of delivery restaurants online.</p>
                            </div>
                        </div>
