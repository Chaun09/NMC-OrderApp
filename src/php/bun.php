            ...
            <ul class="sf-menu">
              ...
              <li class="current" class="dropmenu"><a  href="../menu.php">Menu</a>
                <ul>
                  ...
                  <li><a href="bun.php">Bun Foods</a></li>
              ...
              <li class="dropmenu"><a href="user-profile.php"> My Account <i class="fas fa-caret-down"></i></a>
...
?>
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item" >
                                            <div class="food-item-wrap" style="border-radius:20px;">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['product_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center" style="background-color: black;">
                    <h2>Easy to Order</h2>
